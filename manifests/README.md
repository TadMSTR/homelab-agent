...
See [`docs/components/agent/scoped-mcp.md`](../docs/components/agent/scoped-mcp.md) for the full deployment guide including PM2 config, environment setup, and Vault integration.
